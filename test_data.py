...
def add_golfer(last_name, first_name, email, phone, def_handicap):
    g = Golfer.objects.get_or_create(last_name=last_name, first_name=first_name, email=email, phone=phone,
                                     def_handicap=def_handicap)[0]
    return g


def add_course(name, rating, slope, hole1par, hole2par, hole3par, hole4par, hole5par, hole6par, hole7par, hole8par,
               hole9par, hcap01, hcap02, hcap03, hcap04, hcap05, hcap06, hcap07, hcap08, hcap09):
    c = Course.objects.get_or_create(name=name, rating=rating, slope=slope, hole1par=hole1par, hole2par=hole2par,
                                     hole3par=hole3par, hole4par=hole4par, hole5par=hole5par, hole6par=hole6par,
                                     hole7par=hole7par, hole8par=hole8par, hole9par=hole9par, hcap01=hcap01,
                                     hcap02=hcap02, hcap03=hcap03, hcap04=hcap04, hcap05=hcap05, hcap06=hcap06,
                                     hcap07=hcap07, hcap08=hcap08, hcap09=hcap09)[0]
    return c
