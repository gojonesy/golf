...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Round.points'
        db.add_column(u'golf_round', 'points',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Round.mod_points'
        db.add_column(u'golf_round', 'mod_points',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Round.points'
        db.delete_column(u'golf_round', 'points')

        # Deleting field 'Round.mod_points'
        db.delete_column(u'golf_round', 'mod_points')
