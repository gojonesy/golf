...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Golfer.last_name'
        db.add_column(u'golf_golfer', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Golfer.first_name'
        db.add_column(u'golf_golfer', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Golfer.last_name'
        db.delete_column(u'golf_golfer', 'last_name')

        # Deleting field 'Golfer.first_name'
        db.delete_column(u'golf_golfer', 'first_name')
