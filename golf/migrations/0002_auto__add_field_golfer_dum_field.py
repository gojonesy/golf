...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Golfer.dum_field'
        db.add_column(u'golf_golfer', 'dum_field',
                      self.gf('django.db.models.fields.CharField')(default='Dumb', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Golfer.dum_field'
        db.delete_column(u'golf_golfer', 'dum_field')
    ...
    models = {
        ...
        u'golf.golfer': {
            ...
            'dum_field': ('django.db.models.fields.CharField', [], {'default': "'Dumb'", 'max_length': '128'}),
